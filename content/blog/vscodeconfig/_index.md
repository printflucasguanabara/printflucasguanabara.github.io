...
- I'm assuming that you already have a USB stick with an Arch Linux ISO and are already  [```BOOTABLE```](https://en.wikipedia.org/wiki/List_of_tools_to_create_bootable_USB)
